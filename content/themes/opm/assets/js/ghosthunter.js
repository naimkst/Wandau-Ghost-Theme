...
(function( $ ) {
	...
	var pluginMethods	= {
      ...
      */
        ...
        var url = site_url + "/ghost/api/v3/content/posts/?key=" + search_api_key + "&limit=all&fields=id,title,excerpt,url,published_at,feature_image,visibility&formats=plaintext";
      ...
      $.get(url).done(function(data) {
        searchData = data.posts;
          ...
          var prettyPubDate = prettyDate(parsedData.pubDate);
					...
					blogData[arrayItem.id] = {title: arrayItem.title, excerpt: arrayItem.excerpt, pubDate: prettyPubDate, link: arrayItem.url, featureImage: arrayItem.feature_image};
				});
      });
			this.isInit = true;
		},
